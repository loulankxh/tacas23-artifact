...
contract PausableToken is StandardToken, Pausable {
  ...
  function decreaseApproval(address _spender, uint _subtractedValue) override virtual public whenNotPaused returns (bool success) {
...
/**
* @notice invariant (!(transaction==Tx.DistributeToken && onceFinalize))
*/
