...
contract MintableToken is StandardToken, Ownable {
   ...
   */
  function mint(address _to, uint256 _amount) virtual public onlyOwner canMint returns (bool) {
...
contract Crowdsale is MintableToken {
  ...
  function validPurchase() virtual internal view returns (bool) {
  ...
  function hasEnded() virtual public view returns (bool) {
 ...
 */
/**
* @notice invariant (!(onceFinalized && block.timestamp < endBlock && weiRaised<cap))
*/
contract CappedCrowdsale is Crowdsale {
  ...
  function validPurchase() override internal view returns (bool) {
  ...
  // @return true if crowdsale event has ended
  function hasEnded() virtual override public view returns (bool) {
...
//    assert(!(onceFinalized && block.timestamp < endBlock && weiRaised<cap));
//  }
}
